...
@onready var width_spinbox = get_node("VBoxContainer/width_spinbox")
@onready var height_spinbox = get_node("VBoxContainer/height_spinbox")
@onready var bombs_spinbox = get_node("VBoxContainer/bombs_spinbox")
